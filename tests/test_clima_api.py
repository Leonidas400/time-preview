...
class TestObterClima(unittest.TestCase):
    ...
    def test_get_obter_clima(self, mock_get):
        """
        Nossa requisição de API vai ter esse dicionário como resposta 'fake'.

        O que está sendo testado é se a função obter_clima sabe lidar corretamente
        com uma resposta no formato esperado da API.
        """
        resposta_mock = Mock()
        ...
        # Aqui é onde conectamos o mock com requests.get
